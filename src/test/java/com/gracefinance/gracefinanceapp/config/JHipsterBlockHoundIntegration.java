package com.gracefinance.gracefinanceapp.config;
...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("com.gracefinance.gracefinanceapp.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("com.gracefinance.gracefinanceapp.security.DomainUserDetailsService", "createSpringSecurityUser");
