...
!(function (t) {
    ...
    e._hungarianMap || r(e),
      t.each(n, function (r) {
        (l = e._hungarianMap[r]) === a ||
          (!i && n[l] !== a) ||
          ('o' === l.charAt(0) ? (n[l] || (n[l] = {}), t.extend(!0, n[l], n[r]), o(e[l], n[l], i)) : (n[l] = n[r]));
      });
  }
  function i(t) {
    ...
    for (e = 0, n = f.length; e < n; e++)
      if (((s = f[e]), (c = []), !s.sType && s._sManualType)) s.sType = s._sManualType;
        ...
        for (r = 0, o = h.length; r < o; r++) {
          for (
            i = 0, l = d.length;
            i < l && (c[i] === a && (c[i] = _(t, i, e, 'type')), (u = h[r](c[i], t)) || r === h.length - 1) && 'html' !== u;
            i++
          );
          if (u) {
            s.sType = u;
        ...
        if ('' !== o)
          for (var s = 0, u = (l = T(o)).length; s < u; s++) {
            if (((o = l[s].match(ce)), (i = l[s].match(fe)), o)) {
              if (
                ((l[s] = l[s].replace(ce, '')), '' !== l[s] && (e = e[l[s]]), (i = []), l.splice(0, s + 1), (l = l.join('.')), t.isArray(e))
              )
    ...
    var i,
      ...
      g = function (e) {
        (r !== a && r !== f) ||
          ...
          l && l._bAttrSrc
            ? (x(l.mData._)(o, s), p(l.mData.sort, e), p(l.mData.type, e), p(l.mData.filter, e))
            : h
    ...
    for (u && (o = t('<tr/>').appendTo(l)), n = 0, a = f.length; n < a; n++)
      (i = f[n]),
        ...
        e.oFeatures.bSort &&
          ...
          !1 !== i.bSortable && (r.attr('tabindex', e.iTabIndex).attr('aria-controls', e.sTableId), Tt(e, i.nTh, n))),
      ...
      if (0 !== c.length)
        ...
        (r = l.sZeroRecords),
          ...
          (n[0] = t('<tr/>', { class: i ? o[0] : '' }).append(
            t('<td />', { valign: 'top', colSpan: b(e), class: e.oClasses.sRowEmpty }).html(r),
          )[0]);
      ...
      if (((i = null), '<' == (l = d[h]))) {
        if (((s = t('<div/>')[0]), "'" == (u = d[h + 1]) || '"' == u)) {
          ...
          'H' == c ? (c = n.sJUIHeader) : 'F' == c && (c = n.sJUIFooter),
            -1 != c.indexOf('.')
              ? ((u = c.split('.')), (s.id = u[0].substr(1, u[0].length - 1)), (s.className = u[1]))
              : '#' == c.charAt(0)
  ...
  function B(e, n, a) {
    ...
    (c = {
      ...
      error: function (n, a) {
        ...
        -1 === t.inArray(!0, r) &&
          ('parsererror' == a ? Lt(e, 0, 'Invalid JSON response', 1) : 4 === n.readyState && Lt(e, 0, 'Ajax error', 7)),
          ft(e, !1);
      },
    }),
      (e.oAjaxData = n),
    ...
    var a = e.oClasses,
      ...
      c =
        ...
        (l = function () {
          ...
          t != i.sSearch &&
            (G(e, { sSearch: t, bRegex: i.bRegex, bSmart: i.bSmart, bCaseInsensitive: i.bCaseInsensitive }), (e._iDisplayStart = 0), k(e));
        }),
  ...
  function G(t, e, n) {
    ...
    if ((m(t), 'ssp' != Mt(t))) {
      for (
        Y(t, e.sSearch, n, e.bEscapeRegex !== a ? !e.bEscapeRegex : e.bRegex, e.bSmart, e.bCaseInsensitive), i(e), e = 0;
        e < o.length;
        e++
      )
  ...
  function Y(t, e, n, a, r, o) {
    ...
    if ((0 !== qt.ext.search.length && (n = !0), (i = K(t)), 0 >= e.length)) t.aiDisplay = l.slice();
      ...
      for (
        (i || n || o.length > e.length || 0 !== e.indexOf(o) || t.bSorted) && (t.aiDisplay = l.slice()), e = t.aiDisplay, n = 0;
        n < e.length;
        n++
      )
  ...
  function lt(e) {
    for (
      var n = e.oClasses,
        ...
        i = ((r = i ? r[1] : r), t('<select/>', { name: a + '_length', 'aria-controls': a, class: n.sLengthSelect })),
        l = 0,
        s = o.length;
      l < s;
      l++
    ...
    if (y || (!v && !s && !l && c == b(n) && c == d.length))
      ...
      for (
        ...
        (r = i[f[a]]),
          ...
          r.sWidthOrig && s && t(d[a]).append(t('<div/>').css({ width: r.sWidthOrig, margin: 0, padding: 0, border: 0, height: 1 }));
      if (n.aoData.length)
      ...
      for (
        t('[name]', c).removeAttr('name'),
          ...
          s && u
            ? c.width(u)
            : s
              ? (c.css('width', 'auto'), c.removeAttr('width'), c.width() < m.clientWidth && g && c.width(m.clientWidth))
              : l
    ...
    for (
      ...
      for (n = 0, r = (o = c[(s = f[e][0])].aDataSort).length; n < r; n++)
        (i = o[n]),
          ...
          u.push({ src: s, col: i, dir: f[e][1], index: f[e]._idx, type: l, formatter: qt.ext.type.order[l + '-pre'] });
    return u;
  }
  function yt(t) {
    var e,
    ...
    if ('ssp' != Mt(t) && 0 !== r.length) {
      ...
      s === r.length
        ...
        : u.sort(function (t, e) {
            ...
            for (s = 0; s < c; s++)
              if (
                ((u = r[s]), (n = f[u.col]), (a = d[u.col]), (u = i[u.type + '-' + u.dir] || i['string-' + u.dir]), (n = u(n, a)), 0 !== n)
              )
                return n;
            return (n = o[t]) < (a = o[e]) ? -1 : n > a ? 1 : 0;
          });
      ...
      s.removeAttribute('aria-sort'),
        n.bSortable &&
          (0 < r.length && r[0].col == o
            ? (s.setAttribute('aria-sort', 'asc' == r[0].dir ? 'ascending' : 'descending'), (n = l[r[0].index + 1] || l[0]))
            : (n = l[0]),
  ...
  function xt(t, e) {
    ...
    for (var o, i = qt.ext.type.order[a.sType + '-pre'], l = 0, s = t.aoData.length; l < s; l++)
      (a = t.aoData[l]),
        ...
        (!a._aSortData[e] || r) && ((o = r ? n[l] : _(t, l, e, 'sort')), (a._aSortData[e] = i ? i(o) : o));
  }
  function It(e) {
  ...
  function At(e, n, r) {
    ...
    n = function (n) {
      if (n && n.time) {
        ...
        if (
          -1 === t.inArray(!1, s) &&
          !((0 < (s = e.iStateDuration) && n.time < +new Date() - 1e3 * s) || (n.columns && l.length !== n.columns.length))
        ) {
          if (
    ...
    return (
      e <= n
        ...
        : t <= a
          ...
          : (t >= e - 1 - a ? (n = ie(e - (n - 2), e)) : ((n = ie(t - a + 2, t + a - 1)).push('ellipsis'), n.push(e - 1)),
        ...
        this.each(function () {
          ...
          if ('table' != this.nodeName.toLowerCase()) Lt(null, 0, 'Non-table node initialisation (' + this.nodeName + ')', 2);
            ...
            (I.nTable = this),
              ...
              g.aLengthMenu &&
                !g.iDisplayLength &&
                (g.iDisplayLength = t.isArray(g.aLengthMenu[0]) ? g.aLengthMenu[0][0] : g.aLengthMenu[0]),
              (g = Pt(t.extend(!0, {}, m), g)),
              Rt(
                I.oFeatures,
                g,
  ...
  (Vt = function (e, n) {
    ...
    t.extend(Vt.prototype, {
      ...
      iterator: function (t, e, n, r) {
        ...
        return d.length || r
          ? (((e = (t = new Vt(h, t ? d.concat.apply([], d) : d)).selector).rows = p.rows), (e.cols = p.cols), (e.opts = p.opts), t)
          : this;
      },
      lastIndexOf:
        me.lastIndexOf ||
  ...
  var De = function (e, n, r, o, i) {
    ...
    ye = function (e) {
      return (
        e || (e = {}), e.filter && e.search === a && (e.search = e.filter), t.extend({ search: 'none', order: 'current', page: 'all' }, e)
      );
    },
    _e = function (t) {
        ...
        l = function (e, n) {
          if (t.isArray(e) || e instanceof t) for (var a = 0, r = e.length; a < r; a++) l(e[a], n);
            ...
            e.nodeName && 'tr' === e.nodeName.toLowerCase()
              ? i.push(e)
              : ((a = t('<tr><td/></tr>').addClass(n)), (t('td', a).addClass(n).html(e)[0].colSpan = b(o)), i.push(a[0]));
        };
  ...
  Xt('columns()', function (e, n) {
    ...
    Jt('columns().search()', 'column().search()', function (e, n, r, o) {
      return this.iterator('column', function (i, l) {
        ...
        i.oFeatures.bFilter &&
          (t.extend(s[l], { sSearch: e + '', bRegex: null !== n && n, bSmart: null === r || r, bCaseInsensitive: null === o || o }),
  ...
  var Fe = function (t, e, n, a) {
    return 0 === t || (t && '-' !== t)
      ? (e && (t = ee(t, e)), t.replace && (n && (t = t.replace(n, '')), a && (t = t.replace(a, ''))), 1 * t)
      : -1 / 0;
  };
          ...
          t(e.nTable).on('order.dt.DT', function (t, o, i, l) {
            e === o &&
              ...
              n
                ...
                .addClass('asc' == l[t] ? r.sSortAsc : 'desc' == l[t] ? r.sSortDesc : a.sSortingClass));
          });
        },
            ...
            t(e.nTable).on('order.dt.DT', function (t, o, i, l) {
              e === o &&
                ...
                n
                  ...
                  .removeClass(
                    r.sSortJUIAsc + ' ' + r.sSortJUIDesc + ' ' + r.sSortJUI + ' ' + r.sSortJUIAscAllowed + ' ' + r.sSortJUIDescAllowed,
                  )
