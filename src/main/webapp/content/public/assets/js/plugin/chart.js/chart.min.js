            ...
            acquireContext: function (t, e) {
              ...
              return i && i.canvas === t
                ? ((function (t, e) {
                    ...
                    if (
                      ((t[a] = { initial: { height: n, width: o, style: { display: i.display, height: i.height, width: i.width } } }),
      ...
      52: [
        function (t, e, i) {
          ...
          var n = t(25),
            ...
            s = o.noop;
          n._set('global', {
            title: { display: !1, fontStyle: 'bold', fullWidth: !0, lineHeight: 1.2, padding: 10, position: 'top', text: '', weight: 2e3 },
          });
          var l = a.extend({
            initialize: function (t) {
                ...
                return (
                  ...
                  (y._offsets =
                    ...
                    (d = w).offset &&
                      o.length &&
                      (d.time.min ||
                        ((c = o.length > 1 ? o[1] : s), (v = o[0]), (b = (h(a, 'time', c, 'pos') - h(a, 'time', v, 'pos')) / 2)),
                      d.time.max ||
                        ((c = o[o.length - 1]),
    ...
    : ((t.prototype.beforeDatasetsUpdate = function (t) {
        ...
        for (var e = this.ctx, i = this.chartInstance, o = t._meta[Object.keys(t._meta)[0]], a = 0, s = 0; s < o.data.length; s++) {
          ...
          if (0 !== n.circumference || this.showZero) {
            switch (this.render) {
              ...
              default:
                ...
                (l = parseFloat(l.toFixed(this.precision))),
                  this.showActualPercentages || (100 < (a += l) && ((l -= a - 100), (l = parseFloat(l.toFixed(this.precision))))),
                  (h = l + '%');
            }
            if (
              ('function' == typeof this.render &&
                'object' ==
                  typeof (h = this.render({ label: i.config.data.labels[s], value: t.data[s], percentage: l, dataset: t, index: s })) &&
                (h = this.loadImage(h)),
              !h)
            )
              break;
            ...
            if (
              ...
              u || (u = (c + n.outerRadius) / 2), (e.fillStyle = p), (e.textBaseline = 'middle'), this.drawArcText(h, u, n, this.overlap);
            else {
              ...
              (this.overlap ||
                ('outside' === this.position
                  ...
                  : r.inRange(n, g) && r.inRange(n, x) && r.inRange(c, g) && r.inRange(c, x))) &&
                this.fillText(h, d, p);
            }
            e.restore();
          }
      ...
      (t.prototype.fillText = function (t, e, i) {
        ...
        'object' == typeof t
          ...
          : ((o.fillStyle = i), (o.textBaseline = 'top'), (o.textAlign = 'center'), o.fillText(t, e.x, e.y - this.fontSize / 2));
      }),
          ...
          if ('string' == typeof t)
            for (a.rotate(n), o = 0; o < t.length; o++)
              (n = t.charAt(o)),
                ...
                a.restore(),
                a.rotate(s.width / e);
          else a.rotate((h + i) / 2), a.translate(0, -1 * e), this.fillText(t, { x: 0, y: 0 });
        a.restore();
      }),
