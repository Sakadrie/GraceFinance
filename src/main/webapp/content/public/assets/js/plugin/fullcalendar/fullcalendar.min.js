...
!(function (t, e) {
  ...
  return (function (t) {
    ...
    function (t, e, n) {
      ...
      function _(t) {
        var e,
          ...
          r = [];
        for (
          'string' == typeof t ? (r = t.split(/\s*,\s*/)) : 'function' == typeof t ? (r = [t]) : ht.isArray(t) && (r = t), e = 0;
          e < r.length;
          e++
        )
          (n = r[e]),
            'string' == typeof n
              ? i.push('-' === n.charAt(0) ? { field: n.substring(1), order: -1 } : { field: n, order: 1 })
      ...
      function G(t, e, n) {
        ...
        return U(n)
          ? (e - t) / n
          : ((i = n.asMonths()), Math.abs(i) >= 1 && ut(i) ? e.diff(t, 'months', !0) / i : e.diff(t, 'days', !0) / n.asDays());
      }
      function N(t, e) {
        var n, i;
        return U(t) || U(e)
          ...
          return (
            ...
            (t.prototype.intersect = function (e) {
              ...
              return (
                ...
                (null == n || null == i || n < i) &&
                  ((r = new t(n, i)), (r.isStart = this.isStart && n === this.startMs), (r.isEnd = this.isEnd && i === this.endMs)),
                r
              );
            }),
                ...
                e
                  ? ((i = { left: s.getEvX(e), top: s.getEvY(e) }),
                    ...
                    o &&
                      ...
                      (this.origHit && (n = s.intersectRects(this.origHit, n) || n), (r = s.getRectCenter(n))),
      ...
      var i = n(2),
        ...
        a = (function (t) {
          function e(e) {
            ...
            return (
              (e = e || {}), (n.overflowX = e.overflowX || e.overflow || 'auto'), (n.overflowY = e.overflowY || e.overflow || 'auto'), n
            );
          }
          return (
            i.__extends(e, t),
        ...
        p = (function (t) {
          ...
          return (
            ...
            (e.prototype.triggerExternalDrop = function (t, e, n, i, r) {
              this.publiclyTrigger('drop', { context: n[0], args: [t.dateProfile.start.clone(), i, r, this] }),
            ...
            (e.prototype.processRangeUnselect = function (t) {
              ...
              this.isSelected &&
                ...
                (((e = this.opt('unselectCancel')) && r(t.target).closest(e).length) || this.unselect(t));
            }),
        ...
        o = (function () {
          ...
          return (
            ...
            (t.prototype.getSegClasses = function (t, e, n) {
              var i = ['fc-event', t.isStart ? 'fc-start' : 'fc-not-start', t.isEnd ? 'fc-end' : 'fc-not-end'].concat(
            ...
            (t.prototype._getTimeText = function (t, e, n, i, r) {
              return (
                ...
                this.displayEventTime && !n ? (r && e ? this.view.formatRange({ start: t, end: e }, !1, i) : t.format(i)) : ''
              );
            }),
    ...
    function (t, e, n) {
      ...
      e.default = {
        parse: function (t, e) {
          return r.isTimeString(t.start) || i.isDuration(t.start) || r.isTimeString(t.end) || i.isDuration(t.end)
            ? s.default.parse(t, e)
            : o.default.parse(t, e);
        },
      };
            ...
            (t.prototype.buildNewDateProfile = function (t, e) {
              ...
              return (
                ...
                this.forceTimed
                  ...
                  : this.forceAllDay && (n.hasTime() && n.stripTime(), i && i.hasTime() && i.stripTime()),
            ...
            (t.prototype.setScrollVel = function (t, e) {
              (this.scrollTopVel = t),
                ...
                (!this.scrollTopVel && !this.scrollLeftVel) ||
                  ...
                  (this.scrollIntervalId = setInterval(r.proxy(this, 'scrollIntervalFunc'), this.scrollIntervalMs));
            }),
              ...
              for (e = 0; e < this.rowCnt; e++)
                for (n = e * a, i = n + a - 1, r = n; r <= i; r++)
                  (o = Math.max(u, r)),
                    ...
                    (o = Math.ceil(o)),
                    (s = Math.floor(s)),
                    o <= s && c.push({ row: e, firstRowDayIndex: o - n, lastRowDayIndex: s - n, isStart: o === u, isEnd: s === d });
              return c;
            }),
        ...
        s = (function (t) {
          ...
          return (
            ...
            (e.prototype.handleClick = function (t, e) {
              !1 ===
                this.component.publiclyTrigger('eventClick', { context: t.el[0], args: [t.footprint.getEventLegacy(), e, this.view] }) &&
                e.preventDefault();
            }),
                ...
                E = function (n) {
                  for (; D < n; )
                    (l = m.getCellSegs(t, D, e)),
                      l.length &&
                        ((c = i[e - 1][D]), (y = m.renderMoreLink(t, D, l)), (v = r('<div/>').append(y)), c.append(v), w.push(v[0])),
                      D++;
                };
              if (e && e < b.segLevels.length) {
                for (
                  n = b.segLevels[e - 1], i = b.cellMatrix, o = b.tbodyEl.children().slice(e).addClass('fc-limited').get(), s = 0;
                  s < n.length;
                  s++
                ) {
        ...
        return (function (t) {
          ...
          return (
            ...
            (e.prototype.renderBgIntroHtml = function () {
              var t = this.view;
              return this.colWeekNumbersVisible
                ? '<td class="fc-week-number ' + t.calendar.theme.getClass('widgetContent') + '" ' + t.weekNumberStyleAttr() + '></td>'
                : '';
            }),
            (e.prototype.renderIntroHtml = function () {
              var t = this.view;
            ...
            return (
              ...
              i.opt('weekNumbers') &&
                (i.opt('weekNumbersWithinDays')
                  ...
                  : ((i.dayGrid.cellWeekNumbersVisible = !1), (i.dayGrid.colWeekNumbersVisible = !0))),
        ...
        d = (function () {
          ...
          return (
            ...
            (t.prototype.isSelectionFootprintAllowed = function (t) {
              ...
              return (
                !!this.isFootprintAllowed(t, r, this.opt('selectConstraint'), this.opt('selectOverlap')) &&
    ...
    function (t, e, n) {
      ...
      (e.default = u),
        (u.prototype.applyProps = function (t) {
          ...
          return (
            t.start && (this.startTime = o.duration(t.start)), t.end && (this.endTime = o.duration(t.end)), t.dow && this.setDow(t.dow), e
          );
        }),
          ...
          return (
            ...
            (t.prototype.initialRender = function () {
              ...
              e.addClass('fc'),
                ...
                this.opt('handleWindowResize') &&
                  r(window).resize((this.windowResizeProxy = s.debounce(this.windowResize.bind(this), this.opt('windowResizeDelay'))));
            }),
            ...
            (t.prototype.updateToolbarButtons = function (t) {
              ...
              this.toolbarsManager.proxyCall(
                i.isValid && !t.currentUnzonedRange.containsDate(e) ? 'enableButton' : 'disableButton',
                'today',
              ),
            ...
            (t.prototype.updateEvent = function (t) {
              ...
              i instanceof R.default &&
                ((e = i.buildInstance()), (n = T.default.createFromRawProps(e, t, null)), this.eventManager.mutateEventsWithId(i.id, n));
            }),
            ...
            (t.prototype.buildRangeFromDuration = function (t, e, n, s) {
              ...
              return (
                h ||
                  ...
                  l ? ((u = i.duration(l)), (h = u < n ? r.computeDurationGreatestUnit(u, l) : s)) : (h = s)),
          ...
          return (
            ...
            (e.prototype.handleMouseDown = function (t, e) {
              this.component.canStartResize(t, e) &&
                this.buildDragListener(t, r(e.target).is('.fc-start-resizer')).startInteraction(e, { distance: 5 });
            }),
            ...
            (e.prototype.computeEventStartResizeMutation = function (t, e, n) {
              ...
              return (
                ...
                ((i = new a.default()), i.setStartDelta(l), (r = new s.default()), r.setDateMutation(i), r)
              );
            }),
            (e.prototype.computeEventEndResizeMutation = function (t, e, n) {
              ...
              return (
                ...
                ((i = new a.default()), i.setEndDelta(l), (r = new s.default()), r.setDateMutation(i), r)
              );
            }),
            e
          );
                  ...
                  t.hit && (u = t.hit),
                    ...
                    p && f
                      ? ((i = o.computeEventDropMutation(p, f, h)),
                        i ? ((v = c.buildMutatedEventInstanceGroup(h.id, i)), (y = s.isEventInstanceGroupAllowed(v))) : (y = !1))
                      : (y = !1),
                    y || ((i = null), r.disableCursor()),
                    i &&
                    a.renderDrag(s.eventRangesToEventFootprints(v.sliceRenderRanges(s.dateProfile.renderUnzonedRange, d)), t, g.isTouch)
                      ? n.hide()
                      : n.show(),
                    l && (i = null);
                },
            ...
            return this.opt('weekNumbers')
              ? ((t = i.format(this.opt('smallWeekFormat'))),
                '<th class="fc-axis fc-week-number ' +
                  ...
                  e.axisStyleAttr() +
                  '>' +
                  e.buildGotoAnchorHtml({ date: i, type: 'week', forceOff: this.colCnt > 1 }, u.htmlEscape(t)) +
                  '</th>')
            ...
            (e.prototype.sliceRangeByTimes = function (t) {
              ...
              for (n = 0; n < this.daysPerRow; n++)
                (e = t.intersect(this.dayRanges[n])) &&
                  i.push({ startMs: e.startMs, endMs: e.endMs, isStart: e.isStart, isEnd: e.isEnd, dayIndex: n });
              return i;
            }),
                ...
                u &&
                  i.each(u.split(' '), function (t, s) {
                    ...
                    i.each(s.split(','), function (t, s) {
                      ...
                      h.length > 1
                        ? ((u = i('<div/>')), f && u.addClass(o.getClass('buttonGroup')), u.append(h), l.append(u))
                        : l.append(h);
                  }),
                l
              );
        ...
        f = (function () {
          ...
          return (
            (t.prototype.requestEvents = function (t, e, n, i) {
              return (
                (!i && this.currentPeriod && this.currentPeriod.isWithinRange(t, e) && n === this.currentPeriod.timezone) ||
          ...
          return (
            ...
            (t.prototype.stop = function (t, e) {
              ...
              this.isFollowing &&
                ...
                this.stopListeningTo(i(document)),
                t && r && !this.isHidden
                  ? ((this.isAnimating = !0), this.el.animate({ top: this.top0, left: this.left0 }, { duration: r, complete: o }))
                  : o());
            }),
        ...
        c = (function (t) {
          ...
          return (
            ...
            (e.prototype.compareForwardSegs = function (t, e) {
              return (
                e.forwardPressure - t.forwardPressure || (t.backwardCoord || 0) - (e.backwardCoord || 0) || this.compareEventSegs(t, e)
              );
            }),
                  ...
                  for (l = 0; l < r.length; l++) {
                    for (
                      u = r[l],
                        ...
                        u.leftCol !== u.rightCol ? d.attr('colspan', u.rightCol - u.leftCol + 1) : (y[i][o] = d);
                      o <= u.rightCol;
            ...
            (e.prototype.handleClick = function (e, n) {
              ...
              t.prototype.handleClick.call(this, e, n),
                r(n.target).closest('a[href]').length ||
                  ((i = e.footprint.eventDef.url) && !n.isDefaultPrevented() && (window.location.href = i));
            }),
            e
          );
        })(o.default);
