...
!(function (a, b) {
  ...
  function va(a, b, c, d, e) {
    var f,
      ...
      j = 1 + 7 * (b - 1) + h + i;
    return (
      j <= 0 ? ((f = a - 1), (g = pa(f) + j)) : j > pa(a) ? ((f = a + 1), (g = j - pa(a))) : ((f = a), (g = j)), { year: f, dayOfYear: g }
    );
  }
  function wa(a, b, c) {
    var d,
  ...
  function gb(b) {
    ...
    return null !== c
      ...
      : (eb(b),
        void (b._isValid === !1 && (delete b._isValid, fb(b), b._isValid === !1 && (delete b._isValid, a.createFromInputFallback(b)))));
  }
  function hb(a, b, c) {
    ...
    return (
      Bb(a)
        ...
        : g(a)
          ...
          : (h = Te.exec(a))
            ? ((c = '-' === h[1] ? -1 : 1),
              (f = { y: 0, d: u(h[ge]) * c, h: u(h[he]) * c, m: u(h[ie]) * c, s: u(h[je]) * c, ms: u(Cb(1e3 * h[ke])) * c }))
            : (h = Ue.exec(a))
              ? ((c = '-' === h[1] ? -1 : 1),
                (f = { y: Tb(h[2], c), M: Tb(h[3], c), w: Tb(h[4], c), d: Tb(h[5], c), h: Tb(h[6], c), m: Tb(h[7], c), s: Tb(h[8], c) }))
              : null == f
                ? (f = {})
                : 'object' == typeof f &&
                  ('from' in f || 'to' in f) &&
