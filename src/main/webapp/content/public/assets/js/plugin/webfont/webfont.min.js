...
(function () {
  ...
  U.prototype.V = function (a) {
    ...
    b.u &&
      t(
        ...
        [b.e.d(b.f, a.getName(), I(a).toString(), 'loading'), b.e.d(b.f, a.getName(), I(a).toString(), 'inactive')],
      );
    J(b, 'fontactive', a);
    this.ba = !0;
    ma(this);
  ...
  function ma(a) {
    0 == --a.P &&
      a.Y &&
      (a.ba ? ((a = a.p), a.u && t(a.j, [a.e.d(a.f, 'active')], [a.e.d(a.f, 'loading'), a.e.d(a.f, 'inactive')]), J(a, 'active')) : K(a.p));
  }
  function na(a) {
    this.F = a;
    this.q = new ha();
      ...
      setTimeout(function () {
        ...
        if (0 === c.length && f) K(b.p);
          ...
          for (h = 0; h < c.length; h++) {
            ...
            q = null;
            null === V &&
              (V = window.FontFace ? ((q = /Gecko.*Firefox\/(\d+)/.exec(window.navigator.userAgent)) ? 42 < parseInt(q[1], 10) : !0) : !1);
