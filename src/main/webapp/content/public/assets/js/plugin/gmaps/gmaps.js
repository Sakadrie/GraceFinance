  ...
  return (
    (c.prototype.createControl = function (e) {
      ...
      e.id && (t.id = e.id),
        ...
        e.content &&
          ('string' == typeof e.content ? (t.innerHTML = e.content) : e.content instanceof HTMLElement && t.appendChild(e.content)),
      ...
      return (
        ...
        google.maps.event.addListener(l, 'rightclick', function (o) {
          (o.marker = this),
            ...
            void 0 != window.context_menu[t.el.id].marker && t.buildContextMenu('marker', o);
        }),
        l.fences &&
    ...
    (c.prototype.drawCircle = function (e) {
      ...
      for (
        var t = new google.maps.Circle(e),
          o = ['click', 'dblclick', 'mousedown', 'mousemove', 'mouseout', 'mouseover', 'mouseup', 'rightclick'],
          n = 0;
        n < o.length;
        n++
      )
    ...
    (c.prototype.addLayer = function (e, t) {
      ...
      switch (((t = t || {}), e)) {
        ...
        case 'places':
          if (
            ((this.singleLayers.places = o = new google.maps.places.PlacesService(this.map)), t.search || t.nearbySearch || t.radarSearch)
          ) {
            var n = {
    ...
    (c.prototype.getRoutes = function (e) {
      ...
      (t.origin = /string/.test(typeof e.origin) ? e.origin : new google.maps.LatLng(e.origin[0], e.origin[1])),
        (t.destination = /string/.test(typeof e.destination) ? e.destination : new google.maps.LatLng(e.destination[0], e.destination[1])),
        (t.travelMode = n),
        (t.unitSystem = i),
        delete t.callback,
        delete t.error;
    ...
    (c.prototype.renderRoute = function (e, t) {
      var o,
        n = 'string' == typeof t.panel ? document.getElementById(t.panel.replace('#', '')) : t.panel;
      (t.panel = n),
        (t = r({ map: this.map }, t)),
    ...
    (c.prototype.drawSteppedRoute = function (e) {
      ...
      if (e.origin && e.destination)
            ...
            if ((o.length > 0 && e.start && e.start(o[o.length - 1]), o.length > 0 && e.step)) {
              ...
              if (n.legs.length > 0)
                for (var i, r = n.legs[0].steps, s = 0; (i = r[s]); s++) {
                  i.step_number = s;
                  var a = { path: i.path, strokeColor: e.strokeColor, strokeOpacity: e.strokeOpacity, strokeWeight: e.strokeWeight };
        ...
        for (var o, n = e.route.legs[0].steps, i = 0; (o = n[i]); i++) {
          o.step_number = i;
          var r = { path: o.path, strokeColor: e.strokeColor, strokeOpacity: e.strokeOpacity, strokeWeight: e.strokeWeight };
    ...
    (c.prototype.createPanorama = function (e) {
      return (
        (e.hasOwnProperty('lat') && e.hasOwnProperty('lng')) || ((e.lat = this.getCenter().lat()), (e.lng = this.getCenter().lng())),
    ...
    (c.createPanorama = function (e) {
      ...
      for (
        var o = ['closeclick', 'links_changed', 'pano_changed', 'position_changed', 'pov_changed', 'resize', 'visible_changed'],
          n = r({ visible: !0 }, e),
          i = 0;
        i < o.length;
        i++
        ...
        (google.maps.Polygon.prototype.containsLatLng = function (e) {
          ...
          for (var o = !1, n = this.getPaths().getLength(), i = 0; i < n; i++)
            for (var r = this.getPaths().getAt(i), s = r.getLength(), a = s - 1, l = 0; l < s; l++) {
              var p = r.getAt(l),
                c = r.getAt(a);
              ((p.lng() < e.lng() && c.lng() >= e.lng()) || (c.lng() < e.lng() && p.lng() >= e.lng())) &&
                p.lat() + ((e.lng() - p.lng()) / (c.lng() - p.lng())) * (c.lat() - p.lat()) < e.lat() &&
                (o = !o),
                (a = l);
            }
          return o;
