  ...
  function b(a, b) {
    'clone' !== a.lastPullMode && (b = !0),
      B &&
        B.state !== b &&
        (i(B, 'display', b ? 'none' : ''),
        b || (B.state && (a.options.group.revertClone ? (C.insertBefore(B, D), a._animate(y, B)) : C.insertBefore(B, y))),
        (B.state = b));
  }
  function c(a, b, c) {
    if (a) {
  ...
  var y,
    ...
    da = (function (a) {
      return (
        ...
        ((a = X.createElement('x')), (a.style.cssText = 'pointer-events:auto'), 'auto' === a.style.pointerEvents)
      );
    })(),
    ea = !1,
    fa = Math.abs,
    ...
    ja = s(function (a, b, c) {
      if (c && b.scroll) {
        ...
        F &&
          ...
          f || g || ((f = (o - m <= k) - (m <= k)), (g = (p - n <= k) - (n <= k)), (f || g) && (d = W)),
            ...
            d &&
              (S.pid = setInterval(function () {
                return (
                  ...
                  'function' == typeof H
                    ? H.call(j, h, i, a)
                    : void (d === W ? W.scrollTo(W.pageXOffset + h, W.pageYOffset + i) : ((d.scrollTop += i), (d.scrollLeft += h)))
                );
              }, 24)));
      }
    }, 30),
    ...
    (a.prototype = {
      ...
      _triggerDragStart: function (a, b) {
        (b = b || ('touch' == a.pointerType ? a : null)),
          b
            ? ((P = { target: y, clientX: b.clientX, clientY: b.clientY }), this._onDragStart(P, 'touch'))
      ...
      _emulateDragOver: function () {
        if (Q) {
          ...
          if ((a && a.shadowRoot && ((a = a.shadowRoot.elementFromPoint(Q.clientX, Q.clientY)), (b = a)), b))
            do {
              if (b[V]) {
                for (; c--; ) ia[c]({ clientX: Q.clientX, clientY: Q.clientY, target: a, rootEl: b });
                break;
              }
              a = b;
          ...
          b
            ? ('touch' === b
                ? (f(X, 'touchmove', c._onTouchMove),
                  ...
                  e.supportPointer && (f(X, 'pointermove', c._onTouchMove), f(X, 'pointerup', c._onDrop)))
      ...
      _onDragOver: function (d) {
        var e,
          ...
          s = k.sort;
        if (
          (void 0 !== d.preventDefault && (d.preventDefault(), !k.dragoverBubble && d.stopPropagation()),
          !y.animated &&
            ((R = !0),
            p &&
              !k.disabled &&
              (q
                ? s || (h = !C.contains(y))
                : O === this || ((p.lastPullMode = N.checkPull(this, p, y, d)) && m.checkPut(this, p, y, d))) &&
              (void 0 === d.rootEl || d.rootEl === this.el)))
        ) {
          if ((ja(d, k, this.el), ea)) return;
          if (((e = c(d.target, k.draggable, j)), (f = y.getBoundingClientRect()), O !== this && ((O = this), (r = !0)), h))
            return b(p, !0), (z = C), void (B || D ? C.insertBefore(y, B || D) : s || C.appendChild(y));
          if (0 === j.children.length || j.children[0] === A || (j === d.target && o(j, d))) {
            ...
            b(p, q),
              l(C, j, y, f, e, g, d) !== !1 &&
                (y.contains(j) || (j.appendChild(y), (z = j)), this._animate(f, y), e && this._animate(g, e));
            ...
            if (v) {
              ...
              G =
                H === L
                  ...
                  : e.previousElementSibling === y || y.previousElementSibling === e
      ...
      _onDrop: function (b) {
        ...
        clearInterval(this._loopId),
          ...
          this.nativeDraggable && (g(X, 'drop', this), g(c, 'dragstart', this._onDragStart)),
          this._offUpEvents(),
          b &&
            ...
            y &&
              ...
              C !== z
                ...
                : y.nextSibling !== D &&
                  ((M = q(y, d.draggable)), M >= 0 && (k(this, C, 'update', y, z, C, L, M), k(this, C, 'sort', y, z, C, L, M))),
              a.active && ((null != M && M !== -1) || (M = L), k(this, C, 'end', y, z, C, L, M), this.save()))),
          this._nulling();
      },
      _nulling: function () {
