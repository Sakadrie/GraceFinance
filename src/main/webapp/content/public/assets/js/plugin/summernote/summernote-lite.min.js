    ...
    3: function (t, e, n) {
            ...
            },
            {
              ...
              value: function (t) {
                ...
                (e.shouldInitialize = e.shouldInitialize || g.ok),
                  e.shouldInitialize() && (e.initialize && e.initialize(), e.events && pt.attachEvents(this.$note, e.events));
              },
            },
            {
              key: 'module',
      ...
      function bt(t, e) {
        ...
        if (0 !== n && pt.isText(a[n - 1])) {
          ...
          l.nodeValue;
          e && l.nextSibling && pt.isText(l.nextSibling) && u === l.nodeValue.length && ((u -= l.nodeValue.length), (l = l.nextSibling)),
            (i = l),
            (n = u);
        }
                    ...
                    pt.walkPoint(
                      ...
                      function (e) {
                        ...
                        pt.isEditable(e.node) ||
                          (o
                            ? (pt.isLeftEdgePoint(e) && s.push(e.node), pt.isRightEdgePoint(e) && C.contains(s, e.node) && (i = e.node))
              ...
              },
              {
                ...
                value: function () {
                  if (pt.isBodyContainer(this.sc) && pt.isEmpty(this.sc))
                    return (this.sc.innerHTML = pt.emptyPara), new t(this.sc.firstChild, 0, this.sc.firstChild, 0);
                  var e,
                    n = this.normalize();
                    ...
                    if ('LI' === l.parentNode.nodeName)
                      ...
                      var u =
                          l.childNodes.length > 1
                            ? pt.splitTree(l, { node: s.parentNode, offset: pt.position(s) + 1 }, { isSkipPaddingBlankHTML: !0 })
                            : null,
                ...
                if (o) {
                  ...
                  if (
                    (1 === this.options.blockquoteBreakingLevel
                      ...
                      : 2 === this.options.blockquoteBreakingLevel && (r = pt.lastAncestor(o, pt.isBlockquote)),
                    r)
                  ) {
                    (n = i()(pt.emptyPara)[0]),
      ...
      (At.where = { Row: 0, Column: 1 }),
        ...
        (At.resultAction = { Ignore: 0, SubtractSpanCount: 1, RemoveCell: 2, AddCell: 3, SumSpanCount: 4 });
      var Ft = (function () {
        function t() {
          !(function (t, e) {
            if (!(t instanceof e)) throw new TypeError('Cannot call a class as a function');
          ...
          (n = [
            ...
            },
            {
              ...
              value: function (t, e) {
                ...
                i()(o).siblings().push(o);
                for (
                  var r = new At(n, At.where.Column, At.requestAction.Add, i()(o).closest('table')[0]).getActionList(), a = 0;
                  a < r.length;
                  a++
                ) {
                  var s = r[a],
                      ...
                      case At.resultAction.AddCell:
                        ...
                        u &&
                          (d > 2
                            ...
                            : 2 === d &&
                              (h.insertBefore(f, h.cells[o]), h.cells[o].removeAttribute('rowSpan'), (h.cells[o].innerHTML = '')));
                        continue;
                      ...
                      case At.resultAction.SubtractSpanCount:
                        ...
                        if (s.colSpan && s.colSpan > 1) {
                          ...
                          l > 2
                            ...
                            : 2 === l && (s.removeAttribute('colSpan'), s.cellIndex === o && (s.innerHTML = ''));
                        }
                        continue;
                      case At.resultAction.RemoveCell:
              ...
              if (!(l > 0 && n.isLimited(l))) {
                ...
                'string' == typeof e && (e = e.trim()),
                  n.options.onCreateLink
                    ...
                    : a && (e = /^([A-Za-z][A-Za-z0-9+-.]*\:|#|\/)/.test(e) ? e : n.options.defaultProtocol + e);
                var u = [];
                if (c) {
                ...
                i.a
                  ...
                  .then(function (t) {
                    o.beforeCommand(),
                      'function' == typeof e
                        ? e(t)
                        : ('string' == typeof e && t.attr('data-filename', e), t.css('width', Math.min(o.$editable.width(), t.width()))),
                      t.show(),
                    ...
                    if (e && (e[1] || e[2])) {
                      var n = e[1] ? t : 'http://' + t,
                        o = this.options.showDomainOnlyForAutolink
                          ? t.replace(/^(?:https?:\/\/)?(?:tel?:?)?(?:mailto?:?)?(?:www\.)?/i, '').split('/')[0]
                          : t,
                ...
                if (this.lastWord) {
                  ...
                  this.options.match(e, function (e) {
                    if (e) {
                      var n = '';
                      if (
                        ('string' == typeof e ? (n = pt.createText(e)) : e instanceof jQuery ? (n = e[0]) : e instanceof Node && (n = e),
                        !n)
                      )
                        return;
              ...
              value: function () {
                var t = this.options.dialogsInBody ? this.$body : this.options.container,
                  e = [
                    ...
                    i()('<div/>')
                      .append(
                        this.ui.checkbox({ className: 'sn-checkbox-use-protocol', text: this.lang.link.useProtocol, checked: !0 }).render(),
                      )
                      .html(),
                  ].join(''),
                ...
                this.$dialog = this.ui
                  .dialog({ className: 'link-dialog', title: this.lang.link.insert, fade: this.options.dialogsFade, body: e, footer: n })
                  .render()
                  .appendTo(t);
              },
            },
          ...
          (n = [
            {
              ...
              value: function () {
                ...
                this.$dialog = this.ui
                  .dialog({ title: this.lang.video.insert, fade: this.options.dialogsFade, body: e, footer: n })
                  .render()
                  .appendTo(t);
              },
            },
              ...
              value: function () {
                ...
                return Object.keys(e)
                  .map(function (n) {
                    ...
                    return (
                      r
                        .append(i()('<label><kbd>' + n + '</kdb></label>').css({ width: 180, 'margin-right': 10 }))
    ...
    51: function (t, e, n) {
      ...
      i()(document).on('click', function (t) {
        i()(t.target).closest('.note-btn-group').length ||
          (i()('.note-btn-group.open').removeClass('open'), i()('.note-btn-group .note-btn.active').removeClass('active'));
      }),
                ...
                callback: function (n) {
                  n.find('.note-holder').each(function () {
                    ...
                    'fore' === e
                      ...
                      : 'back' === e && (n.find('.btn-foreground-color').hide(), n.css({ 'min-width': '210px' }));
                },
                click: function (n) {
                  var o = i()(n.target),
                    r = o.data('event'),
