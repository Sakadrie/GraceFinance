    ...
    function (t, e) {
      t.exports = function (t) {
        ...
        return t.replace(/url\s*\(((?:[^)(]|\((?:[^)(]+|\([^)(]*\))*\))*)\)/gi, function (t, e) {
          ...
          var i;
          return (
            (i = 0 === r.indexOf('//') ? r : 0 === r.indexOf('/') ? n + r : o + r.replace(/^\.\//, '')), 'url(' + JSON.stringify(i) + ')'
          );
        });
      };
    },
    ...
    function (t, e, n) {
      ...
      var l = function (t) {
          var e = t && t.button,
            n = t && t.buttons;
          return (
            void 0 !== e && void 0 !== n && o.throwErr("Cannot set both 'button' and 'buttons' options!"), void 0 !== e ? { confirm: e } : n
          );
        },
        u = function (t) {
