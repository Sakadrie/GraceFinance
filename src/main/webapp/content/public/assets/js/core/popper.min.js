        ...
        : N(
            (function (e) {
              var t,
                ...
                c = -r.scrollTop;
              return (
                'rtl' === m(o || n).direction && (f += i(n.clientWidth, o ? o.clientWidth : 0) - a), { width: a, height: s, x: f, y: c }
              );
            })(d(e)),
          );
  }
  ...
  var me = {
    ...
    fn: function (e) {
      ...
      if (i && a) {
        var p = (function (e, t) {
            return Y(
              'number' != typeof (e = 'function' == typeof e ? e(Object.assign({}, t.rects, { placement: t.placement })) : e) ? e : G(e, k),
            );
          })(o.padding, n),
          u = g(i),
          l = 'y' === f ? D : P,
