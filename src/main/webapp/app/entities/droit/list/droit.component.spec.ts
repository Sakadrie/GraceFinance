...
import { sampleWithRequiredData } from '../droit.test-samples';
...
describe('Droit Management Component', () => {
  ...
  it('should call load all on init', () => {
    ...
    expect(comp.droits()[0]).toEqual(expect.objectContaining({ id: 23804 }));
  });

  describe('trackId', () => {
    it('should forward to droitService', () => {
      const entity = { id: 23804 };
      jest.spyOn(service, 'getDroitIdentifier');
      const id = comp.trackId(entity);
      expect(service.getDroitIdentifier).toHaveBeenCalledWith(entity);
