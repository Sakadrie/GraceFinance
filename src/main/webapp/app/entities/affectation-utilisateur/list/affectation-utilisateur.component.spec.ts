...
import { sampleWithRequiredData } from '../affectation-utilisateur.test-samples';
...
describe('AffectationUtilisateur Management Component', () => {
  let comp: AffectationUtilisateurComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      .overrideTemplate(AffectationUtilisateurComponent, '')
      .compileComponents();
  ...
  it('should call load all on init', () => {
    ...
    expect(comp.affectationUtilisateurs()[0]).toEqual(expect.objectContaining({ id: 4001 }));
  });

  describe('trackId', () => {
    it('should forward to affectationUtilisateurService', () => {
      const entity = { id: 4001 };
      jest.spyOn(service, 'getAffectationUtilisateurIdentifier');
      const id = comp.trackId(entity);
      expect(service.getAffectationUtilisateurIdentifier).toHaveBeenCalledWith(entity);
