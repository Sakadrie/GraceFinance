...
import { sampleWithRequiredData } from '../caisse.test-samples';
...
describe('Caisse Management Component', () => {
  ...
  it('should call load all on init', () => {
    ...
    expect(comp.caisses()[0]).toEqual(expect.objectContaining({ id: 3599 }));
  });

  describe('trackId', () => {
    it('should forward to caisseService', () => {
      const entity = { id: 3599 };
      jest.spyOn(service, 'getCaisseIdentifier');
      const id = comp.trackId(entity);
      expect(service.getCaisseIdentifier).toHaveBeenCalledWith(entity);
