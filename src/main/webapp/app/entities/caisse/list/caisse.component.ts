...
import { CaisseService, EntityArrayResponseType } from '../service/caisse.service';
...
export class CaisseComponent implements OnInit {
  ...
  trackId = (item: ICaisse): number => this.caisseService.getCaisseIdentifier(item);
