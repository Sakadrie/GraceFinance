...
type CategorieFormDefaults = Pick<NewCategorie, 'id' | 'actif'>;

type CategorieFormGroupContent = {
  id: FormControl<ICategorie['id'] | NewCategorie['id']>;
  nom: FormControl<ICategorie['nom']>;
  code: FormControl<ICategorie['code']>;
  typeCategorie: FormControl<ICategorie['typeCategorie']>;
  description: FormControl<ICategorie['description']>;
  actif: FormControl<ICategorie['actif']>;
  entiteFinanciere: FormControl<ICategorie['entiteFinanciere']>;
};
...
export class CategorieFormService {
  createCategorieFormGroup(categorie: CategorieFormGroupInput = { id: null }): CategorieFormGroup {
    ...
    return new FormGroup<CategorieFormGroupContent>({
      ...
      actif: new FormControl(categorieRawValue.actif, {
        validators: [Validators.required],
      }),
      entiteFinanciere: new FormControl(categorieRawValue.entiteFinanciere, {
        validators: [Validators.required],
      }),
    });
  }
