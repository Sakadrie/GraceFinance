...
import { sampleWithRequiredData } from '../entite-financiere.test-samples';
...
describe('EntiteFinanciere Management Component', () => {
  let comp: EntiteFinanciereComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      .overrideTemplate(EntiteFinanciereComponent, '')
      .compileComponents();
  ...
  it('should call load all on init', () => {
    ...
    expect(comp.entiteFinancieres()[0]).toEqual(expect.objectContaining({ id: 8941 }));
  });

  describe('trackId', () => {
    it('should forward to entiteFinanciereService', () => {
      const entity = { id: 8941 };
      jest.spyOn(service, 'getEntiteFinanciereIdentifier');
      const id = comp.trackId(entity);
      expect(service.getEntiteFinanciereIdentifier).toHaveBeenCalledWith(entity);
